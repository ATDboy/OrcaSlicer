    ...
    , m_machine("<null>")
{
    ...
    m_button_management->SetBackgroundColorNormal(StateColor::darkModeColorFor(wxColour("#009688")));
    m_button_management->SetTextColorNormal(*wxWHITE);
    m_button_management->Enable(false);
    m_button_refresh->SetBorderWidth(0);
    m_button_refresh->SetBackgroundColorNormal(StateColor::darkModeColorFor(wxColour("#009688")));
