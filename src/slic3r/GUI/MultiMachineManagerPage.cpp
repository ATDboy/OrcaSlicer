...
void MultiMachineItem::doRender(wxDC& dc)
{
    ...
    if (obj_) {
        ...
        if (state_device == 0) {
            ...
            dc.SetTextForeground(StateColor::darkModeColorFor(wxColour(0, 174, 66)));
            DrawTextWithEllipsis(dc, get_state_device(), FromDIP(DEVICE_LEFT_PRO_INFO), left);
        }
        else if (state_device == 2)
        {
            ...
            dc.SetTextForeground(StateColor::darkModeColorFor(wxColour(0, 150, 136)));
            if (obj_->get_curr_stage() == _L("Printing") && obj_->subtask_) {
                ...
                dc.SetPen(wxPen(StateColor::darkModeColorFor(wxColour(0, 150, 136))));
                dc.SetBrush(wxBrush(StateColor::darkModeColorFor(wxColour(0, 150, 136))));
