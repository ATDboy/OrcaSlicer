    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    m_ams_backup_tip->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#009688")));
    ...
    m_link_edit_nozzle->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#009688")));
    ...
    m_statictext_finish->SetForegroundColour(StateColor::darkModeColorFor(wxColour(0, 150, 136)));
